...
class CoreDataHelper: DBHelperProtocol {
    ...
    func fetch<T: NSManagedObject>(_ objectType: T.Type, predicate: NSPredicate? = nil, limit: Int? = nil) -> Result<[T]> {
    ...
    func fetchFirst<T: NSManagedObject>(_ objectType: T.Type, predicate: NSPredicate?) -> Result<T?> {
        let request = objectType.fetchRequest()
        request.predicate = predicate
    ...
    lazy var persistentContainer: NSPersistentCloudKitContainer = {
        let container = NSPersistentCloudKitContainer(name: "EmployeeServices")
